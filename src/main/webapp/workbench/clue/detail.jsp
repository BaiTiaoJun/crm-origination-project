				...
				$.ajax({
					...
					success: function (data) {
						...
						$.each(data, function (i, n) {
								html += '<tr>';
								html += '<td><input type="checkbox" value="' + n.id + '"  name="sel"/></td>';
								html += '<td>' + n.name + '</td>';
		...
		$.ajax({
			...
			success: function (data) {
				...
				$.each(data, function (i, n) {
					...
					html += "<td>" + n.endDate + "</td>";
					html += "<td>" + n.owner + "</td>";
					html += "<td><a href=\"javascript:void(0);\"  style=\"text-decoration: none;\" onclick=\"unband('" + n.id + "')\"><span class=\"glyphicon glyphicon-remove\"></span>解除关联</a></td>";
					html += "</tr>";
				})
